...
export const DashboardView: React.FC = () => {
  return (
    <ScrollArea className="h-full" viewportClassName="bg-[#0C1321]">
      <div className="min-h-full px-6 py-6 bg-[#0C1321]">
        ...
        <div className="mb-8">
          ...
          <div className="relative">
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(180deg, transparent 0%, rgba(0, 0, 0, 0.2) 30%, rgba(0, 0, 0, 0.4) 100%)",
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      ...
                      e.currentTarget.style.boxShadow =
                        "inset 0 4px 8px rgba(0,0,0,0.3), 0 4px 12px rgba(233, 142, 241, 0.3)";
                    }}
                    onMouseLeave={(e) => {
...
const GameCard: React.FC = () => {
  return (
    ...
    >
      ...
      />
      <div className="p-4 bg-[#09101D]" style={{ backgroundColor: "#09101D" }}>
        <h3

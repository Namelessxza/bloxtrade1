          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="rounded-2xl p-6 mb-6" style={{ backgroundColor: '#0c1321' }}>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="text-center p-4 rounded-xl" style={{ backgroundColor: '#12182B' }}>
                  <div className="text-2xl font-bold mb-2" style={{ color: theme.colors.primary.full }} data-testid="stat-total-trades">
                    {stats?.totalTrades || 0}
                  </div>
                  <p className="text-sm text-gray-400">Total Trades</p>
                </div>
                <div className="text-center p-4 rounded-xl" style={{ backgroundColor: '#12182B' }}>
                  <div className="text-2xl font-bold text-green-500 mb-2" data-testid="stat-completed-trades">
                    {stats?.completedTrades || 0}
                  </div>
                  <p className="text-sm text-gray-400">Completed</p>
                </div>
                <div className="text-center p-4 rounded-xl" style={{ backgroundColor: '#12182B' }}>
                  <div className="text-2xl font-bold text-blue-500 mb-2" data-testid="stat-active-trades">
                    {stats?.activeTrades || 0}
                  </div>
                  <p className="text-sm text-gray-400">Active</p>
                </div>
                <div className="text-center p-4 rounded-xl" style={{ backgroundColor: '#12182B' }}>
                  <div className="text-2xl font-bold text-yellow-500 mb-2" data-testid="stat-reputation">
                    {stats?.reputation || 0}
                  </div>
            ...
            <div className="rounded-2xl p-6" style={{ backgroundColor: '#0c1321' }}>
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 p-4 rounded-xl" style={{ backgroundColor: '#12182B' }}>
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium text-white mb-1">Joined GameXchange</p>
                ...
                <div className="grid grid-cols-2 gap-3">
                  {stats.badges.map((badge: any) => (
                    ...
                    >
                      ...
                      <p className="text-xs font-medium text-white mb-1">{badge.badgeName}</p>
                      <p className="text-xs text-gray-400">
            ...
            <div className="rounded-2xl p-6" style={{ backgroundColor: '#0c1321' }}>
              ...
              <div className="space-y-3">
                <Link href="/create-trade">
                  <button
                    className="w-full px-4 py-3 rounded-xl text-sm font-bold transition-all text-white"
                    style={{
                      background: "linear-gradient(to bottom right, #B850E7, #F59BF3)",
                      border: "1px solid #F59BF3",
                      boxShadow: "inset 0 4px 8px rgba(0,0,0,0.3)",

      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <button className="px-6 py-4 bg-gradient-to-br from-pink-400 via-pink-500 to-pink-600 text-white font-bold rounded-full shadow-xl border-2 border-pink-300 shadow-inner">
              Bubblegum
            </button>
            <button className="px-6 py-4 bg-gradient-to-br from-purple-400 via-purple-500 to-purple-600 text-white font-bold rounded-full shadow-xl border-2 border-purple-300 shadow-inner">
              Grape Candy
            </button>
            <button className="px-6 py-4 bg-gradient-to-br from-green-400 via-green-500 to-green-600 text-white font-bold rounded-full shadow-xl border-2 border-green-300 shadow-inner">
              Mint Fresh
            </button>
            <button className="px-6 py-4 bg-gradient-to-br from-orange-400 via-orange-500 to-orange-600 text-white font-bold rounded-full shadow-xl border-2 border-orange-300 shadow-inner">
              Orange Pop
            </button>
            <button className="px-6 py-4 bg-gradient-to-br from-yellow-400 via-yellow-500 to-yellow-600 text-gray-800 font-bold rounded-full shadow-xl border-2 border-yellow-300 shadow-inner">
              Lemon Drop
            </button>
            <button className="px-6 py-4 bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 text-white font-bold rounded-full shadow-xl border-2 border-blue-300 shadow-inner">
              Blue Razz
            </button>
            <button className="px-6 py-4 bg-gradient-to-br from-red-400 via-red-500 to-red-600 text-white font-bold rounded-full shadow-xl border-2 border-red-300 shadow-inner">
              Cherry Pop
            </button>
            <button className="px-6 py-4 bg-gradient-to-br from-cyan-400 via-cyan-500 to-cyan-600 text-white font-bold rounded-full shadow-xl border-2 border-cyan-300 shadow-inner">
              Ice Blue
            </button>
          </div>
        </div>
